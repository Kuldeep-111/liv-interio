...
const projects = [
  ...
  },
  {
    title: "CLEO COUNTY",
    desc: "(sec 121 Noida) ",
    src: "/assets/images/projects/cleo-county/project-3.webp",
    alt: "project 3",
  },
  {
    title: "IENERGIZER OFFICE",
    desc: "(Sec 60 Noida)",
    src: "/assets/images/projects/ienergizer-office/project-4.webp",
    alt: "project 4",
  },
];
      ...
      <Container>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-[50px] ">
          {projects.map((data, index) => (
           <div key={data?.title} className="md:col-span-6">
                <Card data={data} border={true} height="h-[400px] lg:h-[450px] xl:h-[600px]"/>
           </div>
          ))}
        </div>
      </Container>
