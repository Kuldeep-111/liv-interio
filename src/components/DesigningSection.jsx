...
const DesigningSection = () => {
  return (
    <Section
      id="Designing"
      className="relative bg-[url('/assets/images/designing/desinging-bg.webp')] bg-cover bg-center bg-no-repeat"
    >
      ...
      <Container className="z-2 relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-[50px]">
          <div className="md:col-span-6 flex items-center ">
            <Pera className="w-full md:w-[80%] mx-auto text-justify md:text-left ">
          ...
          <div className="md:col-span-6">
            <ul className="mt-[50px]">
              {designStep.map((step, index) => (
                ...
                >
                  <span className="relative z-11 w-[34px] md:w-[40px] h-[30px] md:h-[40px] bg-[#804b1d] rounded-full flex items-center justify-center text-white text-center font-lato text-[12px] md:text-[14px] font-bold tracking-[1px] custom-lines">
                    {index + 1}
                  </span>

                  <span className="bg-[#fff] w-[calc(100%-80px)] md:w-auto px-[25px] py-[10px] font-montserrat text-[var(--text-primary)] font-[700] text-[14px] md:text-[16px]">
                    {step}
                  </span>
                </li>
              ))}
