            ...
            {item.multiLinks ? (
              <>
                {item.links.map((data, index) => (
                  ...
                  >
                    <Pera
                      className={`hover:text-[var(--text-primary)] !leading-[20px] !text-left  !tracking-[2px] !text-[12px]}`}
                    >
                      {data.label}
                    </Pera>
                  </Link>
              ...
              <Link href={href} target={item.target ? "_blank" : ""}>
                <Pera
    ...
    <Section as="footer" id="footer" className="!pb-[30px] overflow-hidden">
      <Container>
        ...
        <div className="flex justify-between flex-wrap md:flex-nowrap border-t border-[var(--text-primary)] mt-[10px] pt-[10px]">
          <Pera className="">
            © Copyright 2025 - LivInterio | Design by GTF Technologies
          </Pera>
          <div>
            <Link
              href="/disclaimer"
