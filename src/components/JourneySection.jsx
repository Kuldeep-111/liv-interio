    ...
    <Section id='journey'>
        <Container>
            ...
            <div className='grid grid-cols-1 md:grid-cols-12 gap-[5px] my-[40px] md:w-[80%] mx-auto'>
              <div className='md:col-span-6'><Image src="/assets/images/interior/1.webp" alt='before image' width={400} height={0} className='max-w-[600px] w-full h-[350px] lg:h-[400px] xl:h-[500px] object-cover'/></div>
              <div className='md:col-span-6'><Image src="/assets/images/interior/3.webp" alt='before image' width={400} height={0} className='max-w-[600px] w-full h-[350px] lg:h-[400px] xl:-[500px] object-cover'/></div>
            </div>
